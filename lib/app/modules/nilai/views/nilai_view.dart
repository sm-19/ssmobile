...
import 'package:smartschool/app/modules/nilaitugas/views/nilaitugas_view.dart';
import 'package:smartschool/app/modules/nilaiulangan/views/nilaiulangan_view.dart';
            ...
            Container(
                ...
                child: Column(
                  children: [
                    InkWell(
                      child: MyMenu(
                        color: Color.fromARGB(255, 30, 113, 128),
                        title: "Tugas",
                      ...
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => NilaitugasView())),
                    ),
                    InkWell(
                      child: MyMenu(
                          title: "Ulangan",
                          icon: Icons.repeat,
                          color: Color.fromARGB(255, 120, 198, 220)),
                      onTap: () => Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => NilaiulanganView())),
                    ),
                    MyMenu(
                        title: "UTS : 85",
                        icon: Icons.group,
